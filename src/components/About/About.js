    ...
    return(
        <div className="about" id="about">
            ...
            <div className="text-light section2"  data-aos="fade-left">
                ...
                We are a team of 7 people, we all work hard and mastery, and the name of the Crypto Blenders team remains more famous and trusted. We have reached this stage because of the cooperation of the team by working as one because cooperation is the basis of success in teamwork and we trust that
